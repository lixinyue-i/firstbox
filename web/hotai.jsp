...
<div class="page" id="app">
            ...
            <div class="nav-list">
                <ul>
                    <li class="nav-tab a_active waves-effect">
                        <a href="menu/device/device.html" class="li-a active" target="iframe">
                    ...
                    <li class="nav-tab nav-ul">
                        <a href="javascript:void[0]" class="li-a"><i class='bx bx-buildings'></i> 订单管理
                            <i class='bx bx-chevron-right' style="float: right;"></i></a>
                        <div class="nav-box">
                            <a href="menu/device/4-1.jsp" class="li-a-a" target="iframe">所有订单</a>
                        </div>
                    </li>
                    </li>
                </ul>
    ...
    <div class="nav-right" ref="navRight">
        ...
        <div class="content-page" ref="cPage">
            <iframe name="iframe" width="100%" height="100%" frameborder="0" src="Desktop/JavaWeb-ShoppingMall-master/JavaWeb-ShoppingMall-master/web/menu/home.html"></iframe>
        </div>
    </div>
</div>
